...
if __name__ == '__main__':
    ...
    parser.add_argument('--include_eof', action='store_true', default=False, help='EOF flag')
            ...
            with torch.no_grad():
                with ctx:
                    y = model.generate(x, max_new_tokens, temperature=temperature, top_k=top_k,
                                       symmetrized=symmetrized, include_eof=include_eof)
